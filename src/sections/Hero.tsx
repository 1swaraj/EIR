    ...
    <section className="relative flex min-h-[100svh] flex-col overflow-hidden border-b border-ink-800/80">
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 pb-20 pt-[calc(env(safe-area-inset-top)+3.5rem)] sm:px-6 md:px-10 md:pb-24 lg:px-12">
        <div className="mx-auto w-full max-w-3xl text-center">
          <Reveal>
            <div className="flex flex-col items-center gap-4 border-b border-ink-800/50 pb-8 sm:flex-row sm:justify-center sm:gap-8">
              <h2 className="min-w-0 font-display text-2xl font-semibold leading-tight tracking-tight text-ink-50 sm:text-3xl md:text-[clamp(1.5rem,1.1rem+1.5vw,2rem)]">
