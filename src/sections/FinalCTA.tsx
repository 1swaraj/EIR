  ...
  return (
    <section id="apply" className="scroll-mt-28 py-28 md:py-36">
      <div className="mx-auto max-w-6xl px-4 md:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-ink-800/90 bg-gradient-to-br from-ink-900/80 via-ink-950 to-ink-950 px-8 py-16 shadow-[0_40px_120px_-56px_rgba(0,0,0,0.95)] md:px-16 md:py-20">
          ...
          <IconCorner className="pointer-events-none absolute bottom-5 right-5 h-9 w-9 rotate-180 text-accent/20 md:bottom-8 md:right-8" />
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.2fr_auto] lg:items-center lg:gap-16">
            ...
            <Reveal className="min-w-0 shrink-0" delay={120}>
              <div className="flex flex-col items-start gap-4 lg:items-end">
                <a
                  href={APPLY_URL}
                  className="group inline-flex w-full items-center justify-center gap-2 rounded-full bg-ink-100 px-10 py-4 font-sans text-sm font-semibold text-ink-950 shadow-[0_0_0_1px_rgba(255,255,255,0.08)_inset] transition hover:bg-white lg:w-auto"
                >
                  Apply now
